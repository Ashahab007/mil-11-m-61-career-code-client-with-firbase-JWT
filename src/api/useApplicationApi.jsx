...
const useApplicationApi = () => {
  ...
  // 4.6 copy the fetch url from 1.3 my application page. here localhost:3000 is removed as we have used as baseUrl in 4.1. so we use the rest of the portion of the url
